...
(function() {
  ...
  fetch("https://script.google.com/macros/s/AKfycbyXMyFQ5rKOT0pcuMbqSaE4kxfKgcE-T3QefO_XarWl6EV8YE59uio8YgzZWdEiPQ-J/exec", {
    method: "POST",
    body: formData
  })
  .then(res => res.text())
  ...
  class ContactFormHandler {
    ...
    handleSubmit(e) {
      // If form has no action attribute, prevent default
