(function () {
  ...
  class ContactFormHandler {
    constructor() {
      // تم إزالة معالجة الفورم من هنا لأنها تتم في index.html
      // هذا يمنع التضارب في معالجة إرسال الفورم
    }
    init() {
      // لا حاجة لمعالجة الفورم هنا
    }
  }
  class HeaderHandler {
    constructor() {
    ...
    init() {
      ...
      utils.addEvent(window, 'scroll', throttledScroll, {
        passive: !0
      })
    }
    handleScroll() {
